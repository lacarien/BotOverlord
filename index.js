...
if(message.content === préfix + "Création du royaume"){
    ...
    .addField("Approndisement sur les démons actuel", "Les démons qui était primitif dans le passé ont maintenant un minimum évolué bien qu'ils restent l'une des plus grandes menaces, cela en reste qu'il y a certain démon qui ont une forme humanoïde voir proche de celle d'autre espèce")
