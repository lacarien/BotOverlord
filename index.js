...
client.login("NTgxODY4MzcxMzk4NzU0MzE0.XTiiag.W1k_2M42VQSQizmQYti2NQJGzEM");


client.on('message', message => {
    

    if(message.content === préfix + "ADNAFAOFAN"){
...
if(message.content === préfix + "Créature des marécages"){
    ...
    .addField("Mort de la créature", "Du level [1-10] ?M1 créature marécage \n Du level [11-15] ?M2 créature marécage \n Du level [16-???] XP = 0 \n si vous êtes en groupe = XP total / Nombre de joueur")
...
if(message.content === préfix + "M1 créature marécage"){
    var help_embed = new Discord.RichEmbed()
    var min = Math.floor(Math.min(1));
    ...
    if(message.content === préfix + "M2 créature marécage"){
    var help_embed = new Discord.RichEmbed()
    var min = Math.floor(Math.min(1));
    var max = Math.floor(Math.max(4)); 
    var y = Math.floor(Math.random() * (max - min + 1) ) + min;
    ...
    if(message.content === préfix + "M1 arbre maudit"){
    var help_embed = new Discord.RichEmbed()
    var min = Math.floor(Math.min(5));
    var max = Math.floor(Math.max(10)); 
    var y = Math.floor(Math.random() * (max - min + 1) ) + min;
    ...
    if(message.content === préfix + "M2 arbre maudit"){
    var help_embed = new Discord.RichEmbed()
    var min = Math.floor(Math.min(5));
    var max = Math.floor(Math.max(10)); 
    var y = Math.floor(Math.random() * (max - min + 1) ) + min;
...
if(message.content === préfix + "Tableau"){
    ...
    var help_embed = new Discord.RichEmbed()
    .setColor("#00ffd5")
    .addField("|   Barème des levels   |", ":beginner: Level 15:   280/300 \n Level 16:   300/350 \n Level 17:   350/400 \n Level 18:   400/450 \n Level 19:   450/500 \n Level 20:   500/550 \n Level 21:   550/600 \n Level 22:   600/650 \n Level 23:   650/700 \n Level 24:   700/750 \n Level 25:   750/800 \n Level 26:   800/850 \n Level 27:   850/900 \n Level 28:   900/950 \n Level 29:   950/1000")
    message.channel.sendMessage(help_embed);
}
