...
if(message.content === préfix + "Grand Assassin"  || message.content === préfix + "grand assassin"){
    ...
    .addField(":chart_with_upwards_trend: **Liste des attaques du grand assassin**", "?PC Gassassin")
...
if(message.content === préfix + "Combattant"  || message.content === préfix + "combattant"){
    ...
    .addField(":chart_with_upwards_trend: **Liste des attaques du combattant**", "?PC Combattant")
...
if(message.content === préfix + "Gardien"  || message.content === préfix + "gardien"){
    ...
    .addField(":chart_with_upwards_trend: **Liste des attaques du gardien**", "?PC Gardien")
...
if(message.content === préfix + "Clerc"  || message.content === préfix + "clerc"){
    ...
    .addField(":chart_with_upwards_trend: **Liste des attaques du clerc**", "?PC Clerc")
...
if(message.content === préfix + "Ranger"  || message.content === préfix + "ranger"){
    ...
    .setTitle("Ranger")
    .addField(":trident: **Bonus**", "Aucun")
    .addField(":chart_with_upwards_trend: **Liste des attaques du ranger**", "?PC Ranger")
...
if(message.content === préfix + "Mage"  || message.content === préfix + "mage"){
    ...
    .addField(":chart_with_upwards_trend: **Liste des attaques du mage**", "?PC Mage")
